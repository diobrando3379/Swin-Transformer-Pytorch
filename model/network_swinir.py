...
class SwinIR(nn.Module):
    ...
    def __init__(self, img_size=64, patch_size=1, in_chans=3, out_chans=3, # TODD:我加了out_chans参数
        ...
        num_in_ch = in_chans
        num_out_ch = out_chans # TODD:我加了out_chans参数
        num_feat = 64
...
if __name__ == '__main__':
    ...
    print(height, width, model.flops() / 1e9)
    x = torch.randn((1, 4, height, width))  # 输入通道数为4
    x = model(x)
